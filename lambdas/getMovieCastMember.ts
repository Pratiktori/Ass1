...
const isValidQueryParams = ajv.compile(
  (schema.definitions as any)["MovieCastMemberQueryParams"] || {}
);
  ...
  try {
    ...
    if (!isValidQueryParams(queryParams)) {
      return {
        ...
        body: JSON.stringify({
          ...
          schema: (schema.definitions as any)["MovieCastMemberQueryParams"],
        }),
      };
    }
    ...
    if (!movieId) {
      return {
        ...
        body: JSON.stringify({
          message: "Missing or invalid movieId parameter",
        }),
      };
    }
